---
title: "MatrixQCvis: shiny-based interactive data quality exploration of omics data"
author:
...
vignette: >
    %\VignetteIndexEntry{Shiny-based interactive data quality exploration of omics data}
...
# Prepare the environment {#sec-prepare}
...
# QC analysis of TCGA RNA-seq data
...
`Dimension Reduction`, and `DE`, the sidebars allows the user for 
 ...
 - transformation: currently the methods `log`, `log2`, `vsn` 
...
```{r hist_sample, eval=TRUE, echo=FALSE, crop=NULL, out.width = "200px", dpi=65}
...
```{r mosaic, eval=TRUE, echo=FALSE, crop=NULL, out.width = "200px", dpi=65}
se_tmp <- se
...
```{r boxplot, eval=TRUE, echo=FALSE, warning=FALSE, crop=NULL, out.width = "200px", dpi=65}
...
```{r drift, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, crop=NULL, out.width = "200px", dpi=65}
...
```{r cv, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, crop=NULL, out.width = "200px", dpi=65}
a <- assay(se)
...
```{r meansdplot, eval=TRUE, echo=FALSE, warning=FALSE, crop=NULL, out.width = "200px", dpi=65}
...
where $I_i$ and $I_j$  are per definition `log2`-transformed values. 
...
```{r maplot, eval=TRUE, echo = FALSE, show=FALSE, crop=NULL, out.width = "200px", dpi=65}
...
```{r ecdf, eval=TRUE, echo=FALSE, crop=NULL, out.width = "200px", dpi=65}
...
```{r distSampe, eval=TRUE, echo=FALSE, crop=NULL, warning=FALSE, message=FALSE, out.width = "200px", dpi=65}
a <- assay(se)
...
```{r featurePlot, eval=TRUE, echo=FALSE, crop=NULL, out.width = "200px", dpi=65}
...
```{r cvFeaturePlot, eval=TRUE, echo=FALSE, crop=NULL, out.width = "200px", dpi=65}
...
a <- assay(se)
a_n <- a %>% normalizeAssay(., "none")
a_t <- a_n %>% transformAssay(., "none")
a_i <- a_t %>% imputeAssay(., "MinDet")
...
```{r volcano, eval=TRUE, echo=FALSE, crop=NULL, out.width = "200px", dpi=65}
partial_bundle(volcanoPlot(tT, type = "ttest"))
```



# QC analysis of proteomics data
...
a <- tbl_mean[, cols_a_start:ncol(tbl_mean)] |>
    as.matrix()
rownames(a) <- pull(tbl_mean, "protein_id")

## create rowData object
rD <- tbl_mean[, seq_len(cols_a_start - 1)] |>
    as.data.frame()
rownames(rD) <- pull(tbl_mean, "protein_id")
...
```{r shinyQC_proteomics, eval = FALSE}
shinyQC(se)
```
...
```{r samplesMeasuredMissing, eval=TRUE, echo=FALSE, crop=NULL, out.width = "200px", dpi=65}
...
```{r histFeature_measured, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, crop=NULL, out.width = "200px", dpi=65}
...
```{r histFeature_missing, eval=FALSE, echo=FALSE, message=FALSE, warning=FALSE, crop=NULL, out.width = "200px", dpi=65}
...
```{r histFeatureCategory, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, crop=NULL, out.width = "200px", dpi=65}
...
```{r upsetmeasured, eval=TRUE, echo=FALSE, crop=NULL, out.width = "200px", dpi=65}
...
```{r upsetmissing, eval=FALSE, echo=FALSE, crop=NULL, out.width = "200px", dpi=65}
